...
class OrganizationSeeder extends Seeder
{
    public function run(): void
    {
        $organizations = [
            ...
            ['Architecture Student Council (ASC)', 'Academic', 'The officially recognized course-based student organization of the BS Architecture.'],
            ...
            ['UP Mindanao Biological Society', 'Academic', 'Empowers biology students to become agents of change through science and research.'],
            ...
            ['UP Mindanao Dance Ensemble', 'Cultural', 'Rooted in Mindanao, dedicated to promoting cultural and modern dance styles.'],
            ...
            ['UP Mindanao Bidlisiw', 'Cultural', 'Organization for visual artists that aims to create a space that sparks creativity.'],
            ...
            ['UPMIN LeaDS', 'Civic', 'A socio-academic organization of DOST Scholars aiming to bring science closer to the people.'],
            ['UAPSA', 'Academic', 'Student organization of the United Architects of the Philippines.'],
            ...
            ['Youth For Animals (YFA-UPMIN)', 'Civic', 'Dedicated to fostering compassion, respect, and kindness towards animals.'],
        ...
        foreach ($organizations as $org) {
            Organization::create([
                ...
                'category'    => $org[1],
                'description' => $org[2],
                'password'    => Hash::make('admin123'), // Hashing the password for security
                'expiration'  => Carbon::now()->addYear(), // Sets expiration to 1 year from now
